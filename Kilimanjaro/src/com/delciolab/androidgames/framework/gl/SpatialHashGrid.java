...
public class SpatialHashGrid {
	...
	public void SpatialHasGrid(float worldWidth, float worldHeight, float cellSize) {
	//public SpatialHasGrid(float worldWidth, float worldHeight, float cellSize) {
		this.cellSize = cellSize;
		this.cellsPerRow = (int)FloatMath.ceil(worldWidth/cellSize);
		this.cellsPerCol = (int)FloatMath.ceil(worldHeight/cellSize);
		int numCells = cellsPerCol * cellsPerCol;
